    ...
    return (
        <Grid container sx={[theme.custom.buySaveCard.bg]} >
            ...
            >
                ...
                >
                    {props.view ? (
                        <Button sx={theme.custom.Button} onClick={()=>props.setViewTable(true)} >
                            View
                        </Button>
                    ) : (
                        <Button onClick={()=>props.setShowEdit(true)}   sx={theme.custom.Button} >
                            Add <AddIcon sx={theme.custom.editButton.iconStyle} />
                        </Button>
                    )}
