            ...
            >
                ...
                {props.list?.map(x => {
                    if (x.head) {
                        return (
                            <>
                                <Typography sx={[theme.custom.typography.reports, { marginLeft: 2, color: "black", mt: 5,fontWeight:"bold" }]}>{x.head}</Typography>
                                <Typography sx={[theme.custom.typography.reports, { marginLeft: 2 }]}>{x.title1}</Typography>
                                <Typography sx={[theme.custom.typography.reports, { marginLeft: 2 }]}>{x.title2}</Typography>
                                {x.title3 ? (<Typography sx={[theme.custom.typography.reports, { marginLeft: 2 }]}>{x.title3}</Typography>) : (null)}
                            </>
                        )
                    } else {
                        return (
