...
import { updateClarity,getClarityById } from "src/apis/clarity";
...
const query = useQuery({
  querKey:['Clairty',router.query.id],
  queryFn:()=>getClarityById(router.query.id),
  ...
  const clarityMutation = useMutation({
    ...
    onSuccess: (res) => {
      swal("Clarity Updated !", res.message, "success"), router.push("/clarity/view-clarity");
    },
        ...
        >
          <Grid item xl={3} lg={3} sm={6} xs={12}>
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <LoadingButton
                disabled={clarityMutation.isLoading}
                loading={clarityMutation.isLoading}
                type="submit"
                sx={{
                  marginTop: 2,
