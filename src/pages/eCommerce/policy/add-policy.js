...
import { postPolicy } from "src/apis/policy";
...
export default function AddPolicy() {
  ...
  const policyMutation = useMutation({
    ...
    onSuccess: (res) => {
      swal("Policy Added !", res.message, "success"), router.push("/policy/view-policy");
    },
  ...
  return (
    <>
      {/* ------------------------------ */}
      <Head>
        <title>Dashboard | Add-Policy </title>
      </Head>
      {/* ------------------------------ */}
      <Container
        sx={{
