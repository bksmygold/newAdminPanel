...
import { updateVariety,getVarietyById } from "src/apis/variety";
...
const query = useQuery({
  querKey:['variety',router.query.id],
  queryFn:()=>getVarietyById(router.query.id),
  ...
  const varietyMutation = useMutation({
    ...
    onSuccess: (res) => {
      swal("variety Updated !", res.message, "success"), router.push("/variety/view-variety");
    },
