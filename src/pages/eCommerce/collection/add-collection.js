...
import { postCollection } from "src/apis/collection";
...
export default function AddCollection() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      collectionMutation.mutate({data:values});
    },
  });
  ...
  const collectionMutation = useMutation({
    ...
    onSuccess: (res) => {
      swal("Collection Added !", res.message, "success"), router.push("/collection/view-collection");
    },
