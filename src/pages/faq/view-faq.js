        ...
        >
          <Grid item xl={3} lg={3} sm={6} xs={12}>
            ...
            <form onSubmit={addFormik.handleSubmit}>
              ...
              <CustomTextField
                error={
                  addFormik.touched.question && Boolean(addFormik.errors.question)
                }
                helperText={addFormik.touched.question && addFormik.errors.question}
                id="question"
                name="question"
              ...
              <CustomTextField
                error={addFormik.touched.answer && Boolean(addFormik.errors.answer)}
