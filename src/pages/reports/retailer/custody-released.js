...
const custodyReleased = () => {
    ...
    const columns = [
        ...
        {
            field: "referral_type",
            headerName: "referral_type",
            flex: 1,
            minWidth: 100,

        },
        {
            field: "total_custody_released",
            headerName: "total_custody_released",
            minWidth: 100,
    ...
    const rows = [
        {
            ...
            customer: "Nischal",
            referral_type:"vip",
            total_custody_released: 111,
            weight: 1,
            purchase_invoice_number: 132,
            merchant: "Merchant",
            sold_on: "15/07/2013",
            sell_rate: 4.5,
            view_custody: "btn",
    ...
    return (
        <>
            {/* ------------------------------ */}
            <Head>
                <title>Dashboard | Custody Released </title>
            </Head>
            <Grid container>
                <Grid item>
                    <Typography variant="h4" sx={theme.custom.typography.infoCard.h1}>Custody Released :</Typography>
                </Grid>
            </Grid>{' '}
...
custodyReleased.getLayout = (page) => (
    <DashboardLayout>{page}</DashboardLayout>
);

export default custodyReleased;
