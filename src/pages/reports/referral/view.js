    ...
    const referralList = [
        {
            ...
            sub: "Customer referral smart reports, to track all the customer-side referrals",
            url: '/reports/referral/customer'
        },
        {
            title: "Sales Associate",
            sub: "Sales Associate smart reports, to track all the associates referrals",
            url: '/reports/referral/sales-associate'
        },
        {
            title: "Offer Referral",
            sub: "Offer referral smart reports, to track all the offers-side referrals",
            url: '/reports/referral/offer'
        },
        {
            title: "VIP Referral",
            sub: "Vip referral smart reports, to track all the vip-side referrals",
            url: '/reports/referral/vip'
        },
    ]
    //=====================================
