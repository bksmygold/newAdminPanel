...
import { deleteSubBids } from 'src/apis/subBids';
//=======================================================
export default function SubscriptionsBids() {
    ...
    const columns = [
        {
            ...
            flex: 1,
            renderCell: (params) => (
                <p style={theme.custom.typography.table}>{params.row.name}</p>
            ),
        },
        {
            field: 'validity',
...
SubscriptionsBids.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;
